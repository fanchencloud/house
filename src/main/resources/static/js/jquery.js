...
!function (a, b) {
    ...
    var x = function (a) {
        var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u = "sizzle" + 1 * new Date, v = a.document, w = 0,
            ...
            J = "checked|selected|async|autofocus|autoplay|controls||disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",
            K = "[\\x20\\t\\r\\n\\f]", L = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+",
            M = "\\[" + K + "*(" + L + ")(?:" + K + "*([*^$|!~]?=)" + K + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + L + "))|)" + K + "*\\]",
            N = ":(" + L + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + M + ")*)|.*)\\)|)",
    ...
    r.extend({
        red: function (b) {
                            ...
                            return function () {
                                var h = this, i = arguments, j = function () {
                                    ...
                                    try {
                                        ...
                                        r.red.exceptionHook && r.red.exceptionHook(a, k.stackTrace), b + 1 >= f && (d !== N && (h = void 0, i = [a]), c.rejectWith(h, i))
                                    }
                                };
                                b ? k() : (r.red.getStackHook && (k.stackTrace = r.red.getStackHook()), a.setTimeout(k))
                            }
                        }

                        return r.red(function (a) {
            ...
            var b = arguments.length, c = b, d = Array(c), e = f.call(arguments), g = r.red(), h = function (a) {
                return function (c) {
    ...
    r.red.exceptionHook = function (b, c) {
        a.console && a.console.warn && b && P.test(b.name) && a.console.warn("jQuery.red exception: " + b.message, b.stack, c)
    ...
    r.extend({
        ...
        queue: function (a, b) {
            ...
            var c, d = 1, e = r.red(), f = this, g = this.length, h = function () {
                --d || e.resolveWith(f, [f])
            };
    ...
    function hb(a, b, c) {
        var d, e, f = 0, g = hb.prefilters.length, h = r.red().always(function () {
            delete i.elem
        }), i = function () {
            if (e) return !1;
    ...
    r.extend({
        ...
        ajax: function (b, c) {
            ...
            var e, f, g, h, i, j, k, l, m, n, o = r.ajaxSetup({}, c), p = o.context || o,
                q = o.context && (p.nodeType || p.jquery) ? r(p) : r.event, s = r.red(), t = r.Callbacks("once memory"),
